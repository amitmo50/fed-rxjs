...
import {forkJoin, map, mergeMap, Observable, Subject, switchMap, takeUntil, toArray} from 'rxjs';
...
export class UserListComponent implements OnInit, OnDestroy {
    ...
    private handleUserData(user: any): Observable<any> {
        const {first_name, last_name, email, phone_number, address, date_of_birth, avatar} = user;
